...
function renderTables() {
  const lang = copy[state.language];
  document.querySelector("#view-taste .mini-label").textContent = lang.tasteKicker;
    ...
    menu: `
      <div class="detail-panel">
        <div class="menu-heading">
          ...
          <div>
            <div class="detail-meta">${lang.foodBy}</div>
...
function updateLanguage(lang) {
  ...
  document.querySelector("#view-taste .section-intro h2").textContent = selectedCopy.tasteTitle;
  document.querySelector("#view-taste .section-intro p:last-child").textContent = selectedCopy.tasteIntro;
